\begin{abstract}
We encode consecutive primes as residue classes modulo $30$, producing a sequence over 8 states $\{1,7,11,13,17,19,23,29\}$. We construct a first-order transition operator $P$ and compare the two-step operator $P^{(2)}$ to the baseline $P^2$ via $\Delta = P^{(2)} - P^2$.
